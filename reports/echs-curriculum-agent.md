...
- Structural errors: **0**
- Quality warnings: **54**
- Required lesson blocks awaiting dedicated completion: **86**
- Required course-level packages awaiting dedicated completion: **3**

- Current Grade 9 + Path B production backlog: **82 lessons + 2 gateway packages**
...
|---|---:|---:|---:|---:|---:|---:|
| g9-ap-precalculus-readiness | 10 | 49 | 18 | 31 | 0/0 | — |
...
- …and 64 more required items in authoritative order.

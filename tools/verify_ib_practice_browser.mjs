...
if(process.env.ECHS_ROUTE_BRANCH==='1'){
  const routed=[
    ...
    ['**/question-bank/js/ib-private-bank-stream-ui.js*','question-bank/js/ib-private-bank-stream-ui.js','application/javascript; charset=utf-8'],
...
if(!result.streamScript)throw new Error('IB streamed inventory UI was not loaded');

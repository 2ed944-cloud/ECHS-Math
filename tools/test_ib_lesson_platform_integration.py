...
def validate_source(root: Path, errors: list[str]) -> None:
    ...
    require(practice, ("practice-scope-access.css?v=20260730-redesign", "practice-recovery-polish.css?v=20260730-recovery1", "bank.js?v=20260730-calculus-only", "practice-global-bridge.js?v=20260730-redesign", "practice-course-isolation.js?v=20260730-redesign", "mapped-private-bank-practice.js?v=20260802-remove-source-notice1", "mapped-practice.js?v=20260801-dynamic-calculus-banks1", "practice-single-bank.js?v=20260801-private-calculus-banks1", "practice-recovery-ui.js?v=20260730-recovery1", 'id="course"', 'id="bank"', 'id="scope"', 'id="visibility"'), "Focused practice page", errors)

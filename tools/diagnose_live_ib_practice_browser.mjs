...
console.log('LIVE_IB_BROWSER_DIAGNOSTIC=');console.log(JSON.stringify({...result,complete,apiResponses,consoleErrors,pageErrors,failedRequests:failedRequests.slice(0,20)},null,2));
await browser.close();

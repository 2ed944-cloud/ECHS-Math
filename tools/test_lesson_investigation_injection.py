...
class InjectionTests(unittest.TestCase):
    def setUp(self):
        self.temp = tempfile.TemporaryDirectory(prefix="injection-test-", dir=HERE / "lesson-investigations")
    ...
    def tearDown(self):
        ...
        self.assertTrue(self.root.resolve().is_relative_to((HERE / "lesson-investigations").resolve()))
        self.temp.cleanup()

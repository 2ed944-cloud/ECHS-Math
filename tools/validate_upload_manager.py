...
require(fast_processor,['subprocess.Popen','stdout=subprocess.PIPE','status.eq.processing','upload_private_bank_package_fast.py','--expected-course'],'Fast upload processor')
...
for path in ['tools/test_ap_calculus_private_bank_support.py','tools/process_teacher_upload_request.py','tools/process_teacher_upload_request_fast.py','tools/upload_private_bank_package.py','tools/upload_private_bank_package_fast.py','tools/validate_private_bank_packages.py','tools/validate_upload_manager.py','tools/validate_private_bank_import_performance.py']:

...
forbid(center_html+center_js,['keepCalculusOnly','KEEP AP CALCULUS ONLY','REMOVAL_ORDER','private-bank-purge-api'],'Private bank center multi-course preservation')

...
for command,label in [([sys.executable,str(ROOT/'tools/test_private_bank_source_archive_chunking.py')],'Source archive chunking regression'),(['node',str(ROOT/'tools/test_ib_unit1_portal_update.mjs')],'IB Unit 1 portal regression')]:

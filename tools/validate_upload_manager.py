...
require(api,['createSignedUploadUrl','teacher-upload-staging','CHUNK_BYTES=40*1024*1024','chunkMeta','part_paths','upload_mode:"chunked"','Upload part','1.4.0-single-course-routing','missing_course','"ib-math-ai"'],'Upload manager API')
...
require(center_html,['AP Calculus','calcBanks','Open Upload Manager','keepCalculusOnly','Calculus packages'],'Private bank center page')
require(center_js,['REMOVAL_ORDER','ap-precalculus','ib-math-ai','algebra-2','grade-9','KEEP AP CALCULUS ONLY'],'Private bank center client')

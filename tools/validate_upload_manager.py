...
require(practice_api,['assignedCourses','course_not_assigned','student_scope_required','.containedBy("course_keys", [course])','practice-bank-api'],'Course-isolated practice API')
require(practice,['"ap-calculus"','IB Mathematics AI Bank 10','dynamicLabels','practice-bank-api','staff_review_only','dedicated'],'Mapped private practice integration')
require(ib_aliases,['u1-standard-form','u1-arithmetic-sequences','u1-approximation-error','u1-technology-equations','classification.primary_topic=requestedLesson','IB Mathematics AI Bank 10','alias_scope:"exact-only"'],'IB exact visible-lesson private-bank aliases')
forbid(ib_aliases,['"u1-number"','"u1-sequences"','"u1-modeling"'],'IB exact visible-lesson private-bank aliases')

...
if __name__ == "__main__":
    ...
    report = {"contract": "echs.c04.journal-http-service-offline.v1", "status": "PASS" if result.wasSuccessful() else "FAIL", "groups": result.testsRun, "failed": len(result.failures), "errors": len(result.errors), "skipped": len(result.skipped), "docker_executed": False, "database_executed": False, "network_requests": 0}

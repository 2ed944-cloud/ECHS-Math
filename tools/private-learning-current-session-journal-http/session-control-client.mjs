// Derived private client: exact accepted lifecycle, fixed successor control script.
...
export async function control(configPath,python){
 const child=spawn(python,[fileURLToPath(new URL('./session-controls.py',import.meta.url)),configPath],{stdio:['pipe','pipe','ignore']});

...
ASSETS += [BASE + "assets/rates-1-2-v3.css", "data/ap-precalculus-update.js", "sw.js"]
...
for marker in ('data-echs-lesson-guard="1"', 'name="echs-course" content="ap-precalculus"', 'data-framework="fall-2026"', 'rates-1-2-core-v3.js', '24 AP-style MCQs', '6 challenge MCQs'):
...
print("Live AP Precalculus 1.2: PASS — exact commit, protected entry, 55 slides, 10 investigations, 38 checks, 6 FRQs and eight matching assets.")

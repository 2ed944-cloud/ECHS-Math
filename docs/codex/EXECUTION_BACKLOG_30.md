...
- ECHS-009: in progress; additive versioned rich text and visual mathematics, preserving all existing block version 1 documents. New database validation and backend capability checks must pass actual PostgreSQL tests before deployment. No completion or production adoption is claimed yet.

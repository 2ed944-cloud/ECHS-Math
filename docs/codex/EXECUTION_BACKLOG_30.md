...
- ECHS-010: in progress; private images/resources, safe video and accessible tables. Dedicated asset scope, publication attachment, lifecycle and failure tests must pass before merge. Later stages have not started.

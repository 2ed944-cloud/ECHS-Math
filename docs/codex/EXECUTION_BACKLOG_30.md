...
- ECHS-009: PR #356 merged as `8476392f9a62975d7df5f8a695375a4da32809a8` after 19 passing PR workflows. PostgreSQL 15.19 applied all 23 migrations with 235 original plus 203 new checks and eight original plus seven new HTTP/SQL groups. All 16 main/live workflows and 31 public checks passed, but subsequent deployed-path inspection found the server transport omitted the capability RPC, leaving the new controls disabled. A narrow transport repair adds a real handler-to-transport regression and a data-free authoring health probe. Completion and ECHS-010 implementation remain pending that repair's deployment verification. See `LESSON_CONTENT_V2_FOUNDATION.md`.

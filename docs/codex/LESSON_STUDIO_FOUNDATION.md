...
No production teacher data has been created for testing. A real staff account still needs an assigned class and an explicitly pinned active curriculum version. Full publication/history, rich mathematics authoring, media and durable offline editing are not claimed by this stage. ECHS-008 acceptance is complete; ECHS-009 is the next active implementation stage. The broader ECHS-008–030 request remains active.

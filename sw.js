const VERSION = "echs-platform-school-control-v3-pathway2-landing1-builder1-hybrid1";
...
const AUTH_ASSET = /\/(?:css\/(?:institution[^/]*|learning-access|gamification)\.css|js\/(?:institution[^/]*|login|portal-access|lesson-access-guard|gamification-overlay)\.js|question-bank\/js\/(?:admin-accounts|student-cloud|teacher-cloud|parent-cloud|role-entry)\.js)$/i;

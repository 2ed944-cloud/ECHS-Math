(function(){
  ...
  window.LESSON_DATA={
    schemaVersion:'5.1.2',version:'5.1.2',buildDate:'2026-08-08',
    ...
    audit:{release:'5.1.2',learnScreenCount:slides.length,allVisualsPurposeBuilt:true,manualFirstTechnology:true,sourceScopeReviewed:true,studentFacingDevelopmentLabels:false}
  };

...
function markup(){
  ...
  aside.innerHTML=`
    ...
    <div class="u1-ti84-sim-guide">
      <p><b>Use it with the GDC Lab:</b> model first, enter carefully, read the display, interpret the result, then verify mathematically. <span data-u1-ti84-current></span></p>

...
function panel(){
  ...
  aside.innerHTML=`<header class="ti84-inline-head"><button type="button" id="ti84-inline-close" aria-label="Close TI-84 simulator">×</button><div><span>TI‑84 PLUS CE · LIVE CLASSROOM VIEW</span><h2>Simulator beside the slide</h2></div></header>
  <div class="ti84-inline-guidance"><p><b>Classroom routine:</b> keep the worked example visible, demonstrate one calculator step, then students repeat it on the TI‑84 in their hands.</p></div>
...
function init(){
  ...
  data.ti84InlineSimulator={release:'6.3.2',provider:'ti84calc.com',layout:'docked beside slide',lazy:true,sandboxed:true,separatePage:false};
}

...
(function(){
  ...
  $("homeStreak").textContent=summary.streak;$("homeMastered").textContent=summary.mastered;$("homeMastered").title="Verified mastery is unavailable. Recorded practice indicators are provisional.";$("homeDue").textContent=summary.due;$("homeMistakes").textContent=summary.unresolved;

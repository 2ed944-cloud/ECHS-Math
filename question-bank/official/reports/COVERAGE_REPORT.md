...
- Historical FRQs without an available official scoring guideline after
  supplied-source reconciliation: **233**.
- Records blocked because exact required visual information remains
  unavailable: **6**.
- School-internal/non-public legacy records removed from the public runtime:
  **300**.
